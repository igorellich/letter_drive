...
- Итог ~4400+ вопросов в `tests/grades/3grade/subjects/` (математика 1912, русский 807, английский 1245 (602 слова + 641 грамматика), чтение 331, мир 193). Каждая тема ≥10 (нужно для `Scene.tsx` slice(0,10)); цель ~100 в теме, у фактоидных тем (чтение/мир) меньше — допустимо.
